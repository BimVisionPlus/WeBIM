          ...
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white shadow-xl">
            ...
            <form onSubmit={submit} className="space-y-3 px-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Loại khiếu nại</span>
                  <select
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                    value={form.type}
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Hướng khiếu nại</span>
                  <select
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
              ...
              <label className="block">
                <span className="block text-xs font-medium text-slate-700">Mô tả sự việc</span>
                <textarea
                  rows={3}
                  className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Bên bị khiếu nại</span>
                  <input
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Điều khoản HĐ</span>
                  <input
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Giá trị yêu cầu (VND)</span>
                  <input
                    inputMode="numeric"
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Số ngày EOT</span>
                  <input
                    inputMode="numeric"
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                    placeholder="45"
              ...
              <div className="grid grid-cols-3 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Sự kiện từ</span>
                  <input
                    type="date"
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">đến</span>
                  <input
                    type="date"
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Hạn thông báo</span>
                  <input
                    type="date"
                    className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
