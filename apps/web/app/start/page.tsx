      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center px-6 py-12 md:py-20">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-300 md:text-lg">
            ...
            URL riêng <code className="rounded bg-slate-800 px-1.5 py-0.5 text-blue-300">&lt;công-ty&gt;.aecplatform.vn</code>.
            Bạn là OWNER toàn quyền chỉnh sửa.
          </p>
        </div>

        {/* Form */}
        <div className="mt-10 w-full max-w-2xl rounded-2xl bg-white p-6 text-slate-900 shadow-2xl md:p-8">
          <StartForm />
        </div>
        ...
        <div className="mt-10 grid w-full grid-cols-2 gap-4 text-sm md:grid-cols-4">
          <div className="rounded-lg bg-white/5 p-4 backdrop-blur">
            ...
            <div className="mt-0.5 text-xs text-slate-300">Provisioning ngay khi bấm tạo</div>
          </div>
          <div className="rounded-lg bg-white/5 p-4 backdrop-blur">
            <div className="text-2xl">🇻🇳</div>
            <div className="mt-2 font-semibold">100% tiếng Việt</div>
            <div className="mt-0.5 text-xs text-slate-300">VBHN 06/VBHN-BXD · NĐ 06/2021 · TCVN/QCVN</div>
          </div>
          <div className="rounded-lg bg-white/5 p-4 backdrop-blur">
            <div className="text-2xl">🤖</div>
            <div className="mt-2 font-semibold">11 AI features</div>
            <div className="mt-0.5 text-xs text-slate-300">Voice-to-form · Hồ sơ hoàn công · Cost overrun</div>
          </div>
          <div className="rounded-lg bg-white/5 p-4 backdrop-blur">
            <div className="text-2xl">🔐</div>
            <div className="mt-2 font-semibold">Cô lập hoàn toàn</div>
            <div className="mt-0.5 text-xs text-slate-300">Subdomain riêng, không thấy dữ liệu khách khác</div>
          </div>
        </div>

        <p className="mt-8 max-w-2xl text-center text-xs text-slate-400">
