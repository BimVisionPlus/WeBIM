          ...
          <div className="w-full max-w-lg rounded-lg bg-white p-5 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="mt-4 space-y-3" onSubmit={onSubmit}>
              <label className="block">
                <span className="block text-xs font-medium text-slate-700">Tổ chức đứng tên dự thầu *</span>
                <select
                  name="orgId"
                  required
              ...
              <label className="block">
                <span className="block text-xs font-medium text-slate-700">Gắn vào cơ hội đấu thầu (tùy chọn)</span>
                <select
                  name="opportunityId"
                  className="mt-1 w-full rounded-md border border-slate-300 px-2.5 py-1.5 text-sm"
                >
              ...
              <label className="block">
                <span className="block text-xs font-medium text-slate-700">Tên gói thầu *</span>
                <input
                  name="title"
                  required
                  className="mt-1 w-full rounded-md border border-slate-300 px-2.5 py-1.5 text-sm"
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Giá dự toán nội bộ (VND)</span>
                  <input
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Giá dự thầu (VND)</span>
                  <input
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Margin %</span>
                  <input
                    name="marginPct"
                    type="number"
                    step="0.1"
                ...
                <label className="block">
                  <span className="block text-xs font-medium text-slate-700">Contingency %</span>
                  <input
                    name="contingencyPct"
                    type="number"
                    step="0.1"
