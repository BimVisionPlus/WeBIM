...
const aecPlatformModules = [
  ...
  },
  {
    ...
    sub: "Đối ngoại QLNN",
    icon: "🏛",
    desc: "Quan hệ Sở XD/QHKT/TNMT, KBNN, PC07, UBND. Văn bản đi-đến + lịch hẹn + hồ sơ pháp lý per agency. Alert quá hạn trả lời.",
  ...
  {
    name: "MonitorWatch",
    sub: "Quan trắc lún/nghiêng",
    icon: "📡",
    desc: "Quan trắc lún/nghiêng/áp lực nước ngầm/biến dạng/khe nứt/rung động. Leica/Trimble/Topcon ingestion. Vượt ngưỡng → auto-NCR + email TVGS+CĐT.",
    href: `${APP}/monitor`,
    group: "Thi công",
  },
  {
